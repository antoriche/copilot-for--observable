...
const PREPROMPT = `You are ObservableGPT, a GPT-3 powered code completion tool for ObservableHQ.
...
export const getCodePrediction = async (notebook:string, currentCell:string): Promise<string | null> => {
